...
COMMANDS: tuple[OperatorCommand, ...] = (
    ...
    OperatorCommand(
        ...
        cli_template="python -m awrag.cli batch --runtime-root <runtime> --dataset-id <dataset> --questions <questions.txt> --top-k 10 --workers 4",
    ...
    OperatorCommand(
        ...
        cli_template='python -m awrag.cli count-walk-speech --runtime-root <runtime> --dataset-id <dataset> --question "<question>" --out <speech-folder>',
    ...
    OperatorCommand(
        ...
        cli_template="python -m awrag.cli laptop-temp-intake --source <file-or-folder> --state-root <generated-state-root> --run-id <run-id> --chunk-mb 25 --max-chunks 3 --workers 4 --reserve-ram-fraction 0.50",
